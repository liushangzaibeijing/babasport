			...
			<table cellspacing="1" cellpadding="2" border="0" width="100%" class="pn-ftable">
				<tbody>
					<tr>
						...
						<td width="38%" colspan="1" class="pn-fcontent">${buyer.realName}</td>
						<td width="12%" class="pn-flabel pn-flabel-h">手机:</td>
						<td width="38%" colspan="1" class="pn-fcontent">${buyer.email}</td>
					</tr>
					<tr>
						<td width="12%" class="pn-flabel pn-flabel-h">所在地区:</td>
						<td width="38%" colspan="1" class="pn-fcontent">${buyer.province}${buyer.city}${buyer.town}</td>
						<td width="12%" class="pn-flabel pn-flabel-h">地址:</td>
						<td width="38%" colspan="1" class="pn-fcontent">${buyer.addr}</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="38%" colspan="1" class="pn-fcontent"><fmt:formatDate value="${order.createDate}" pattern="yyyy-MM-dd HH:mm:ss.SSS"/></td>
				...
				<tbody class="pn-ltbody">
					...
					<c:forEach items="${orderDetails}" var="orderDetail">
						  <tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
							<td align="center">${orderDetail.productName}</td>
							<td align="center">${orderDetail.color }</td>
							<td align="center">${orderDetail.size }</td>
							<td align="center">${orderDetail.skuPrice }</td>
							<td align="center">${orderDetail.productNo }</td>
