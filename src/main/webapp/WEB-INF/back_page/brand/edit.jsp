...
<div class="body-box" style="float:right">
	<form id="jvForm" action="${pageContext.request.contextPath}/back/brandEdit.do" method="post">
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			<tbody>
				<tr>
				    <input type="hidden" name="id" value="${brand.id}"/>
				    <input type="hidden" name="queryName" value="${name}"/>
				    <input type="hidden" name="queryIsDisplay" value="${isDisplay}"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<img width="100" height="100" id="imgSize1ImgSrc" src="${baseUrl}${brand.imgUrl}"  />
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="sort" value="<c:if test='${brand.sort!=0}'>${brand.sort}</c:if>" maxlength="80"/>
