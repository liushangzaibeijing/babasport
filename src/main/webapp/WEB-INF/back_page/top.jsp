                     ...
                     <div class="nav">
                     	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
                                    	<li class="current" id="tb_11" onclick="HoverLi(11);"><a href="${pageContext.request.contextPath}/back/main.do" target="mainFrame">首页</a></li>
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);"><a href="${pageContext.request.contextPath}/back/product_main.do" target="mainFrame">商品</a></li>
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);"><a href="${pageContext.request.contextPath}/back/order/order_main.do" target="mainFrame">订单</a></li>
