...
<%@ include file="/WEB-INF/back_page/date.jsp" %>
     <ul class="w-lful">
		<li><a href="${pageContext.request.contextPath}/back/productList.do" target="rightFrame">商品管理</a></li>
		<li><a href="${pageContext.request.contextPath}/back/brandList.do" target="rightFrame">品牌管理</a></li>
		<li><a href="${pageContext.request.contextPath}/back/featureList.do" target="rightFrame">类型管理</a></li>
     </ul>
</div>
</body>
</html>