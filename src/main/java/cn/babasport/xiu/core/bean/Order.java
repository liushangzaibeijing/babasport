...
public class Order implements Serializable {
	...
	//支付方式
	private Integer paymentWay;//y
	//付款方式
	private Integer paymentCash; //y
	//送货时间
	private Integer delivery; //y
	//是否电话确认 1:是  0: 否
	private Integer isConfirm; //y
	//支付状态 :0到付 1待付款,2已付款,3待退款,4退款成功,5退款失败
	private Integer isPaiy;
	//订单 1:仓库配货 2:商品出库 3:等待收货 4:完成 5待退货 6已退货
	private Integer state;
	private Date createDate;
	private String note; //附言
	private String buyerId; //y
